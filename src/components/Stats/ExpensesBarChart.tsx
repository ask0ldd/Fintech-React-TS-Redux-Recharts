    ...
    return(
        <ResponsiveContainer className="graph__container" width="100%" height={680}>
            ...
            margin={{
                ...
                <YAxis dataKey="financial.expenses" yAxisId={0} tickCount={7} tick={<CustomizedYTick />}/>
                <XAxis dataKey="month" tickLine={false} tick={<CustomizedXTick />}/>
                <CartesianGrid  strokeDasharray="4 4" vertical={false} stroke="#A4B3C6" />
                <Bar dataKey="financial.expenses" fill="url(#PurpleUV)" maxBarSize={30} yAxisId={0} radius={[3, 3, 0, 0]} label={CustomLabel}/>
