...
function OwnedCurrencyList(){
    return(
        <div className='ownedCurrencyList__container'>
            <h2>Your Wallet</h2>
            <table>
                <thead><tr><th style={{textAlign:'left', width:'60px', paddingLeft:'0.745rem'}}>Currency</th><th>Amount</th><th>Value (USD)</th><th>Price</th><th style={{paddingRight:'0.75rem'}}>Last 30d</th></tr></thead>
                <tbody>
