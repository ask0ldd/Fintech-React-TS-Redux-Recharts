...
function VMenu({activePage} : IProps){
    ...
    return(
        <nav className='vmenu' aria-label='primary'>
            ...
            <Link to="/trading" className={activePage === 'trading' ? 'vmenu-anchor activeItem' : 'vmenu-anchor'}><img style={{transform:'translate(0, -1px)'}} data-testid="accounts-menuItem" src={accountsIcon}/></Link>
