    ...
    return(
        <article className="oneTransaction__container">
            <div className='transaction__datas'>
                <div className='transaction__recipient'><span className={/*'delayed__text'*/ ''}>{company}</span><div style={{display:'none'}} className='default__loading loading__mgp2'></div></div>
                <div className='datenAmount__container'>
                    <span className={'transaction__date'/*+'delayed__text'*/}>{date}</span><span className={amount >= 0 ? 'transaction__amount'/*+'delayed__text*/ : 'transaction__amountRed'/*+'delayed__text*/}>{formatedAmount}</span><div style={{display:'none'}} className='default__loading'></div>
                </div>
