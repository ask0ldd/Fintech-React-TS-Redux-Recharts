...
describe('Given I am on the Stats page / 2', async () => {
    ...
    test('Clicking on the expenses button should display the related graph', async () => {
        ...
        vi.mock('react-router-dom', async () => {
            ...
            return {
                ...OriginalModule,
                useParams: () => ({id : "expenses"})
            }
        })

        render(<MockedRouter />)

        await waitFor(() => expect(screen.getByText(/Monthly Expenses/i)).toBeInTheDocument())
